...
class MovieServise:
    ...
    def get_all(self, genres_args=None, director_args=None, year_args=None, status=None, page=None):
        if director_args and genres_args:
            movies = list(set(self.dao.get_by_director(director_args)) & set(self.dao.get_by_genre(genres_args)))
        elif director_args:
